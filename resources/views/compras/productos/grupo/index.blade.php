        ...
        <div class="flex justify-between items-center text-xs font-semibold tracking-wide text-gray-500 uppercase bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
            ...
            <div class="px-4 py-3">
                <a href="{{ route('grupo.create') }}">
                    <button type="submit" class="px-2 py-1 text-sm font-medium text-white transition-colors duration-200 rounded-md bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 dark:focus:ring-offset-darker">Nuevo Grupo</button>
                </a>
            </div>
            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    @foreach($grupos as $item)
                        ...
                        <td class="px-4 py-3 text-center text-sm">{{$item->IdGrupo}}</td>
                        <td class="px-4 py-3 text-center text-sm">{{$item->NomGrupo}}</td>
                        <td class="px-4 py-3 flex justify-center">
                            <div class="flex items-center space-x-4 text-sm">
                                <a href="{{route('grupo.edit',$item->IdGrupo)}}">
                                <button
                                ...
                                <a href="{{route('grupo.confirmar',$item->IdGrupo)}}">
                                <button
                                    class="flex items-
